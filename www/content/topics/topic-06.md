...
theoretical: "The file system as a tree. Absolute and relative paths, the working directory, and the home directory. The Unix philosophy of small composable tools; permissions as a model of access."
technical: "`pwd`, `ls`, `cd`, `mkdir`, `cp`, `mv`, `rm`; redirection and pipes; running scripts from the shell; basic permissions. In-class: guided terminal workflow exercise."
weight: 60
numsession: 6
---
## Theory
